...
data into QdrantDB and MongoDB, including
point creation and upsert operations. Note
this is specifically for testing data and
not production data, which is handled by the
'push.py' module.
"""
...
async def main() -> None:
	...
	try:
		# If not in test environment, skip pushing test data
		if os.getenv('MWALIKA_ENV') != 'testing':
			cprint(
				'Not in testing environment, skipping corpus push.',
